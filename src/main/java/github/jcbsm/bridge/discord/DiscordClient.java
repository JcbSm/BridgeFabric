...
import github.jcbsm.bridge.discord.listeners.DiscordChatEventListener;
...
public class DiscordClient {
    ...
    public DiscordClient(String token, List<String> relayChannelIds) throws InterruptedException {
        ...
        // ENABLE CHAT RELAY
        if (BridgeConfig.CHAT_RELAY.get().enabled) {
