package github.jcbsm.bridge.discord.listeners;
...
public class DiscordChatEventListener extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (event.getAuthor().isBot() || !BridgeConfig.CHAT_RELAY.get().enabled || !Bridge.discordClient.getRelayChannels().containsKey(event.getChannel().getId()))
            return;
